...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(mxawsiot.actions.DescribeEndpoint.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.DescribeThing.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.GetThingState.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.ListThings.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.ListThingsToEntities.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.PublishMqttMessage.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.SubscribeToTopic.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.UnsubscribeMqttTopic.class);
			component.actionRegistry().registerUserAction(mxawsiot.actions.UpdateThingState.class);
